...
def _customer_welcome() -> str:
    return "\n".join([
        ...
        _DIVIDER,
        "",
        "🌟 <b>Tu tienda de streaming premium en Perú</b>",
        "",
        "✨ <b>Lo que vas a encontrar acá:</b>",
        "",
        "     📺  Perfiles de Netflix, Disney+, HBO, Crunchyroll, Spotify y más",
        "     💸  Ofertas y cupones exclusivos del canal",
        "     🆕  Avisos cuando entra stock nuevo",
        "     ⚡  Reposición rápida si tu perfil se cae",
        "     🎁  Sorteos para suscriptores",
        "",
        _DIVIDER,
        "",
        '🛒  <b>Comprá ya:</b>  <a href="https://ecormecejhelizstore.com">ecormecejhelizstore.com</a>',
