...
urlpatterns = [
    ...
    path("webhooks/flow/confirmacion/", views.flow_confirmation, name="flow_confirmation"),
    path("flow/resultado/<uuid:uuid>/", views.flow_result, name="flow_result"),
    ...
    path("<uuid:uuid>/deposito/", views.bank_payment, name="bank_payment"),
