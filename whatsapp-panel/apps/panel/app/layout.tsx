import'./styles.css';import'./qr.css';import'./store.css';import'./store-auth.css';import'./premium-store.css';import'./typography.css';import'./admin.css';import type{Metadata}from'next';
