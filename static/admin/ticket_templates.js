...
(function(){
    ...
    var match = window.location.pathname.match(/\/panel-jheliz-control\/support\/ticket\/(\d+)\/change\/?$/);
    if(!match) return;
    var ticketId = match[1];

    var API_URL = "/panel-jheliz-control/reply-templates.json?ticket_id=" + encodeURIComponent(ticketId);
